...
// SMTP e-posta gönderme fonksiyonu
function sendSMTPEmail($to, $subject, $body, $fromEmail = 'system@corporate.forte.works', $fromName = 'Forte Tourism') {
    // SMTP ayarları
    $smtpHost = 'corporate.forte.works';
    $smtpPort = 465; // SSL port
    $smtpUsername = 'system@corporate.forte.works';
    $smtpPassword = 'ForteTourism2025';
...
<body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
    ...
    error_log("Password reset SMTP error: " . $e->getMessage());
